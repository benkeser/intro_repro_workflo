...
date: 'Introduction Reproducible Workflows in R<br><br>`r renv::activate("../.."); fontawesome::fa("link", fill = '#ffffff')` [.white[bit.ly/intro_repro_workflo]](https://bit.ly/intro_repro_workflo) <br> `r fontawesome::fa("book", fill = '#ffffff')` [.white[Additional reading]](https://benkeser.github.io/intro_repro_workflo/readings#coding-style)'
...
1. Identify the most important aspects of "good code".
2. Explain the DRY principle.
3. Define self-documenting code.
...
This is literally copied from an old development branch of my `drtmle` R package where I'm working on feature additions. 
