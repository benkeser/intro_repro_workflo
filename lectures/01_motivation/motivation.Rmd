...
the [class readings](https://benkeser.github.io/intro_repro_workflo/readings#reproducible-research) for more. 
...
In this class, we'll be learning to operate almost on 
...
`python` is also becoming quite popular for analysis, 
