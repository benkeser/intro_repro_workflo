...
We can also use LaTeX to do this: \begin{itemize}
  \item LaTeX is pretty helpful
  \item for listing things too!
  \item This only works if rendering to pdf
\end{itemize}
...
We can also use html to do this:

<ol>
  <li>item number 1 (in html)</li>
  <li>item number 2 (in html)</li>
  <li>this works both in pdf and html</li>
</ol>
